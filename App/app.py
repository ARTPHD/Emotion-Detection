...
set_png_as_page_bg('/Users/ASUS/Downloads/Emotion-Detection-Project-main/Emotion-Detection-Project-main/App/emotion.jpg')
...
def main():
	st.title("Deteksi Perasaaan App")
	st.subheader("Klasifikasi dan deteksi perasaan menggunakan text")

	with st.form(key='emotion_clf_form'):
			raw_text = st.text_area("Silahkan Tuliskan perasaan anda di sini dengan menggunakan bahasa inggris")
			submit_text = st.form_submit_button(label='Prediksi')
